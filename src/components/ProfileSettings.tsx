...
import { User, Image as ImageIcon, Shield, Moon, Sun, Monitor, Trash2, LogOut, MapPin, Clock, Plus, Ghost, Sparkles, Key, CheckCircle, XCircle, Loader2, X } from "lucide-react";
...
export function ProfileSettings({ profile, onUpdate, onClose }: { profile: any; onUpdate: () => void; onClose: () => void }) {
  ...
  return (
    <>
      <div className="fixed inset-0 bg-[#030303]/90 backdrop-blur-xl z-50 flex items-center justify-center p-4">
        <div className="bg-[#0a0a0a] border border-white/10 w-full max-w-lg rounded-[3rem] overflow-hidden shadow-2xl flex flex-col max-h-[90vh] relative text-white">
          <div className="p-8 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
            <div>
              ...
              <p className="text-[10px] font-black uppercase tracking-widest text-white/30 mt-1">Persona & Safety</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase tracking-widest text-white/30 px-1">Display Name</Label>
                  <Input 
                    value={fullName} 
                    onChange={(e) => setFullName(e.target.value)}
                    className="bg-white/[0.03] border-white/5 h-12 rounded-2xl focus:ring-indigo-500/30 font-bold text-white placeholder:text-white/10"
                  />
                </div>

                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase tracking-widest text-white/30 px-1">Handle</Label>
                  <Input 
                    value={username} 
                ...
                <div className="space-y-2 md:col-span-2">
                  <Label className="text-[10px] font-black uppercase tracking-widest text-white/30 px-1">Bio</Label>
                  <Input 
                    value={bio} 
...
<div className="space-y-2 md:col-span-2">
                      ...
                      <div className="p-5 bg-red-500/10 border border-red-500/20 rounded-2xl space-y-3">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input 
                            ...
                            className="bg-white/[0.03] border-white/5 h-10 rounded-xl focus:ring-indigo-500/30 text-sm text-white placeholder:text-white/10"
                          />
                          <Button 
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase tracking-widest text-white/30 px-1">Mode</Label>
                  <Select value={theme} onValueChange={setTheme}>
                    <SelectTrigger className="bg-white/[0.03] border-white/5 h-12 rounded-2xl text-white">
                ...
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase tracking-widest text-white/30 px-1">Wallpaper</Label>
                  <Input 
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="p-5 bg-white/[0.02] border border-white/5 rounded-3xl flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[8px] text-white/30 font-black uppercase tracking-widest mt-0.5">Live Presence</p>
                    </div>
                  </div>
                  <Switch 
                ...
                {blockedProfiles.length > 0 && (
                  <div className="space-y-3">
                    <p className="text-[10px] font-black uppercase tracking-widest text-white/30">Restricted Access</p>
          ...
          <div className="p-8 bg-[#050505] border-t border-white/5 flex gap-4">
            <Button 
              ...
              className="flex-1 h-14 rounded-2xl font-black uppercase tracking-widest text-[10px] text-white/20 hover:text-white hover:bg-white/5"
            >
              Sign Out
            </Button>
            <Button 
